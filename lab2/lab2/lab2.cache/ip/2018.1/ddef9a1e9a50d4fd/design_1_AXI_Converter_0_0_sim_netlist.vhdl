...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Converter_v1_0_M00_AXI is
  ...
  signal compare_done_reg_i_1_n_0 : STD_LOGIC;
  signal compare_done_reg_i_2_n_0 : STD_LOGIC;
  signal compare_done_reg_i_3_n_0 : STD_LOGIC;
  signal compare_done_reg_i_4_n_0 : STD_LOGIC;
  signal compare_done_reg_i_5_n_0 : STD_LOGIC;
  ...
  signal start_single_burst_read0 : STD_LOGIC;
  signal start_single_burst_read_reg_i_2_n_0 : STD_LOGIC;
  signal start_single_burst_write : STD_LOGIC;
  signal start_single_burst_write0 : STD_LOGIC;
  signal start_single_burst_write_reg_i_2_n_0 : STD_LOGIC;
  ...
  attribute XILINX_LEGACY_PRIM of ERROR_reg : label is "LDC";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of ERROR_reg_i_1 : label is "soft_lutpair2";
  ...
  attribute XILINX_LEGACY_PRIM of compare_done_reg : label is "LDP";
  attribute SOFT_HLUTNM of compare_done_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of compare_done_reg_i_7 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of error_reg_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of init_txn_ff2_i_1 : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of start_single_burst_read_reg : label is "LDC";
  attribute SOFT_HLUTNM of start_single_burst_read_reg_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of start_single_burst_read_reg_i_2 : label is "soft_lutpair0";
  attribute XILINX_LEGACY_PRIM of start_single_burst_write_reg : label is "LDC";
  attribute SOFT_HLUTNM of start_single_burst_write_reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of start_single_burst_write_reg_i_2 : label is "soft_lutpair5";
begin
...
ERROR_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => compare_done_reg_i_3_n_0,
      D => ERROR_reg_i_1_n_0,
      G => compare_done_reg_i_2_n_0,
      GE => '1',
      Q => error
    );
ERROR_reg_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A020"
        ...
        port map (
      I0 => \^error_reg\,
      I1 => compare_done_reg_i_5_n_0,
      I2 => m00_axi_aresetn,
      I3 => compare_done_reg_i_4_n_0,
      O => ERROR_reg_i_1_n_0
    );
...
compare_done_reg: unisim.vcomponents.LDPE
    generic map(
      INIT => '1'
    )
        port map (
      D => compare_done_reg_i_1_n_0,
      G => compare_done_reg_i_2_n_0,
      GE => '1',
      PRE => compare_done_reg_i_3_n_0,
      Q => done
    );
compare_done_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C0E00020"
    )
        port map (
      I0 => reads_done,
      I1 => compare_done_reg_i_4_n_0,
      I2 => m00_axi_aresetn,
      I3 => compare_done_reg_i_5_n_0,
      I4 => writes_done,
      O => compare_done_reg_i_1_n_0
    );
compare_done_reg_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFE2F0F000E2F0F0"
    )
        port map (
      I0 => reads_done,
      I1 => compare_done_reg_i_5_n_0,
      ...
      I4 => m00_axi_aresetn,
      I5 => writes_done,
      O => compare_done_reg_i_2_n_0
    );
compare_done_reg_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => m00_axi_aresetn,
      O => compare_done_reg_i_3_n_0
    );
compare_done_reg_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => writes_done,
      I5 => mst_exec_state(1),
      O => compare_done_reg_i_4_n_0
    );
compare_done_reg_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEF0020FFEFFFEF"
    )
        port map (
      I0 => reads_done,
      I1 => compare_done_reg_i_5_n_0,
      ...
      I4 => write_nread,
      I5 => \^pulse\,
      O => compare_done_reg_i_5_n_0
    );
compare_done_reg_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0222020002000200"
    )
        port map (
      I0 => m00_axi_aresetn,
      I1 => mst_exec_state(1),
...
compare_done_reg_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => compare_done_reg_i_5_n_0,
      I1 => m00_axi_aresetn,
      I2 => compare_done_reg_i_4_n_0,
      O => mst_exec_state(1)
    );
...
error_reg_i_1_RnM: unisim.vcomponents.LUT6
    generic map(
...
start_single_burst_read_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => compare_done_reg_i_3_n_0,
      D => start_single_burst_read0,
      G => start_single_burst_read_reg_i_2_n_0,
      GE => '1',
      Q => start_single_burst_read
    );
start_single_burst_read_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      O => start_single_burst_read0
    );
start_single_burst_read_reg_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
      ...
      I2 => compare_done_reg_i_4_n_0,
      I3 => reads_done,
      O => start_single_burst_read_reg_i_2_n_0
    );
start_single_burst_write_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      G => start_single_burst_write_reg_i_2_n_0,
      GE => '1',
      Q => start_single_burst_write
    );
start_single_burst_write_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
start_single_burst_write_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
      ...
      I1 => compare_done_reg_i_4_n_0,
      I2 => writes_done,
      O => start_single_burst_write_reg_i_2_n_0
    );
